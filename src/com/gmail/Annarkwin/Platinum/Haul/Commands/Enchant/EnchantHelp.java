...
public class EnchantHelp implements Subcommand , HelpCommand
{
	...
	public EnchantHelp( MainCommand maincommand )
	{
	...
	public void run( CommandSender sender, String[] args )
	{
		...
		if (args.length > 1)
		{
			...
			if (CommandHelper.isPositiveInt(args[1]))
			{
				...
				CommandHelper.sendHelp(sender, entries, "BottleExp", CommandHelper.getInt(args[1]));
