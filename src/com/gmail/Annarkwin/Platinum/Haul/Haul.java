...
public class Haul extends JavaPlugin
{
	...
	{
		PlatinumMainCommand bottleexp = new CommandBottleExp("BottleEXP", "platinum.command.bottleexp", true, "Bottle your exp", "/bxp help (page)");
		bottleexp.addChildCommand(new BottleExpHelp("help", "platinum.command.bottleexp.help", true, "Get bottleexp help", "/bxp help (page)"));
		bottleexp.addChildCommand(new BottleExpFill("fill", "platinum.command.bottleexp.fill", true, "Fill bottles with exp", "/bxp fill <xp>"));
		getCommand("BottleExp").setExecutor(bottleexp);
		
		PlatinumMainCommand enchant = new CommandBottleExp("Enchant", "platinum.command.enchant", true, "Enchant items", "/enchant help (page)");
		enchant.addChildCommand(new EnchantHelp("help", "platinum.command.enchant.help", true, "Get enchant help", "/enchant help (page)"));
		enchant.addChildCommand(new EnchantF("f", "platinum.command.enchant.f", true, "Force enchant an item", "/enchant f <enchant> <level>"));
		enchant.addChildCommand(new EnchantN("n", "platinum.command.enchant.n", true, "Normal enchant an item", "/enchant n <enchant> <level>"));
