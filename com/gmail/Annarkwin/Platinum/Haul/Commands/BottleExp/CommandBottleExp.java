...
public class CommandBottleExp implements CommandExecutor, MainCommand {
	...
	private final Subcommand[] subcommands = { new BottleExpHelp(this), new BottleExpFill(this)};
	...
	//Clear player's exp and gives them exp (effectively setting player's exp amount
